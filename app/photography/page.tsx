...
const subTitle = "";
const description = "";
const descriptionTwoPartOne= "Turning Every Moment into a Lasting Visual Story";
const descriptionTwoPartTwo= " Capturing the Essence with Precision and Passion";


//stories in motion content
const storiesInMotion = [
    {
...
export default function Home() {
    ...
    return (
        <div>
            <PageHero imgUrl={imgUrl} title={title} subTitle={subTitle} description={description} descriptionTwoPartOne={descriptionTwoPartOne} descriptionTwoPartTwo={descriptionTwoPartTwo}/>
            ...
            <section className=" w-full my-6 py-10 text-white flex flex-col items-center justify-start gap-2 ">
                ...
                <div className=" w-[80%] mt-10 sm:mt-5 flex flex-col sm:flex-row sm:gap-5 gap-10 flex-1 items-center justify-center">
                    ...
                    {
                        storiesInMotion.map((event, index) => {
                            return (
