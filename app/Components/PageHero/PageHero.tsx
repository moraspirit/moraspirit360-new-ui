    ...
    return (
        <div className=' relative w-full h-[50vh] mb-10 sm:h-[90vh] overflow-hidden text-white'>
            <ScrollRevealDiv
                ...
                <h1 className='text-4xl sm:text-8xl text-center px-4 font-semibold tracking-tighter'>{title}</h1>
                <h2 className='text-sm sm:text-4xl text-center px-4 text-[#CBCBCB] tracking-tighter font-semibold'>{subTitle}</h2>
                <p className='text-sm sm:text-xl text-center px-4 font-semibold text-[#CBCBCB]'>{description}</p>
