        ...
        <>
            ...
            <section className={`${styles.secondSection} ${styles.scrollUpAnimation} flex flex-col items-center justify-center`}>
                <ScrollUpDiv>
                    ...
                    <p className='font-thin'>
                        MoraSpirit 360 is your go-to partner for event coverage, marketing, 
                        and web development. From stunning visuals to targeted promotions, 
                        we bring your vision to life with creativity and technology.
                    </p>
            ...
            <section className=" w-full my-6 py-10 text-white flex flex-col items-center justify-start gap-2 ">
                <ScrollRevealDiv className="w-full flex flex-col items-center">
                    ...
                    <h2 className=" text-lg sm:text-xl font-medium text-center">A Glimpse into Our Unforgettable Moments</h2>
                </ScrollRevealDiv>
                <div
